...
import { KiwanoSwapFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = KiwanoSwapFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new KiwanoSwapFactory(FACTORY_ADDRESS);

...
import { Pair, Bundle, Token, KiwanoSwapFactory, PancakeDayData, PairDayData, TokenDayData } from "../generated/schema";
...
export function updatePancakeDayData(event: ethereum.Event): PancakeDayData {
  let pancake = KiwanoSwapFactory.load(FACTORY_ADDRESS);
